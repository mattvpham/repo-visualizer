...
export const Tree = ({
  ...
  const compareExtensionsHelper = (a: string[], b: string[]) => {
    const aReversed = a.reverse().join(".");
  ...
  const compareExtensions = (a, b) => {
    return compareExtensionsHelper(a.split("."), b.split("."));
  };
...
const processChild = (
  ...
  const extension = name?.split(".").slice(1).slice(-2).join(".");
